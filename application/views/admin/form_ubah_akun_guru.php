    ...
    <div class="col-lg-8">
        <form method="post" action="<?= base_url('admin/proses_ubah_akun_guru/') . $akun->id; ?>">
            <div class="form-group">
                ...
                <input type="text" class="form-control col-4" id="judulMateri" placeholder="..." name="nuptk" value="<?php echo $akun->nuptk_nisn; ?>" required maxlength="16" minlength="16" pattern="[0-9]+">
            </div>
            <div class="form-group">
