...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2021 at 07:49 AM
...
(12, 5, 1, 4, 'Kuis coba 1', 'Pilihan Ganda', '2021-11-19 02:24:27', '2021-11-19 02:33:19', '2021-11-20 02:24:00');
...
(18, 5, 1, 4, 'test', 'test1\r\n1213232\r\n\r\niy7y7y7', '2021-11-19 02:06:09', '2021-11-18 19:14:36', '2021-11-20 02:14:00'),
(19, 5, 2, 4, 'haha', 'test\r\n3', '2021-11-19 10:09:55', '2021-11-19 03:10:41', '2021-11-20 00:10:00');
...
(12, 5, 4, 12, 'soal 1 baru', 'A', 'V', 'C', 'D', 'b');
...
(3, 'Dicky Febrian Dwiputra', 'admin@gmail.com', 'http://localhost/KP_VLE_SDN-KOPO-01/assets/img/profile/default.jpg', '$2y$10$N.CDZNnYtMPKbzGBKciubODGQyv5eHJXl6uGSq24f8ltBQrvpw7mC', 1, 1, 0, 123456789010111, '', 1631208163),
...
(7, 'Berbakti Faisal', 'siswa@gmail.com', 'http://localhost/KP_VLE_SDN-KOPO-01/assets/img/profile/default.jpg', '$2y$10$vDru8OFu9JXsOL0Aj9hzVu0Q3VekDI/ymvOIOmvumeeKcNH9//aje', 3, 1, 2, 9970017151, '', 1636084746),
...
(13, 'Febrian Dwiputra', 'febriandwiputra@gmail.com', 'http://localhost/KP_VLE_SDN-KOPO-01/assets/img/profile/default.jpg', '$2y$10$IDH3IZ3zGETRxG.9XfS.w.SrYbQuiNaV.pO6HhyKNShFIju0cMTWS', 2, 1, 4, 1231241242141231, 'Wali kelas', 1637259575),
(14, 'Rizka Fanidi', 'rizka@gmail.com', 'http://localhost/KP_VLE_SDN-KOPO-01/assets/img/profile/default.jpg', '$2y$10$KsGmcL1IHRiKL7QKTF47zO4QhHIuku3Bwr0227d8vbTaPPPJDlrJy', 3, 1, 1, 9970017153, '', 1637260123);
...
ALTER TABLE `kelas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_kelrom` (`tingkat`,`rombel`);
